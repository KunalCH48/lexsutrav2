...
const ROLE_OPTIONS = [
  { value: "deployer",          label: "Deployer",               hint: "We use this AI system in our operations" },
  { value: "provider",          label: "Provider",               hint: "We built and distribute this AI system" },
  { value: "provider_deployer", label: "Provider + Deployer",    hint: "We built it and also use it ourselves" },
];
  ...
  function handleRegister() {
    ...
    startTransition(async () => {
      ...
      if ("error" in result) {
        ...
        setStep("success");
        setName(""); setUrl(""); setUseCase(""); setRole(""); setDataSubjects(""); setVendor(""); setDeploymentStatus("active");
        setClassification(null);
      }
    });
  }
  ...
  return (
    <form onSubmit={handleAnalyse} className="space-y-4">
      ...
      <div className="space-y-1.5">
        ...
        />
        <p className="text-xs" style={{ color: "#3d4f60" }}>
          Distinguishes vendor tools from internal builds and creates an auditable record.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            placeholder="e.g. Internal / OpenAI / HireVue"
            disabled={isClassifying}
            className="w-full rounded-lg px-3 py-2.5 text-sm disabled:opacity-50"
            style={inputStyle}
          />
